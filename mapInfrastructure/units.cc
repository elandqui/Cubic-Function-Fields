...
void unit1(){
  ...
  do{
    ...
    cout<<"div(theta_"<<dlen-1<<") = ("<<div1<<", "<<div2<<", "<<div3<<")"<<endl;
...
*/
    ...
    if(deg(autnu = aut(nu0, nu1, nu2)) == ddeg){
      ...
      //Step 3.3
      // theta := theta*alpha
      div1 += deg(LeftShift(a0,shift)+a1*rho+a2*omega)-ddeg-shift;
      div2 += deg(LeftShift(a0,shift)+a1*u*rho+a2*u*u*omega)-ddeg-shift;
      div3 += deg(LeftShift(a0,shift)+a1*u*u*rho+a2*u*omega)-ddeg-shift;
      ...
      div1 += deg(LeftShift(mu0,shift)+mu1*rho+mu2*omega)-ddeg-shift;
      div2 += deg(LeftShift(mu0,shift)+mu1*u*rho+mu2*u*u*omega)-ddeg-shift;
      div3 += deg(LeftShift(mu0,shift)+mu1*u*u*rho+mu2*u*omega)-ddeg-shift;
  ...
  cout<<"div(theta_"<<dlen<<") = ("<<div1<<", "<<div2<<", "<<div3<<")"<<endl;
...
void unit2(){
  ...
  do{
    cout<<"div(phi_"<<m<<") = ("<<div1<<", "<<div2<<", "<<div3<<")"<<endl;
...
*/
    ...
    if(deg(tau = LeftShift(tau0,shift)+tau1*rho+tau2*omega) == ddeg+shift){
      ...
      div1 += deg(LeftShift(b0,shift)+b1*rho+b2*omega)-ddeg-shift;
      div2 += deg(LeftShift(b0,shift)+b1*u*rho+b2*u*u*omega)-ddeg-shift;
      div3 += deg(LeftShift(b0,shift)+b1*u*u*rho+b2*u*omega)-ddeg-shift;
	...
	if(g!=1){
      ...
      div1 += deg(LeftShift(sig0,shift)+sig1*rho+sig2*omega)-ddeg-shift;
      div2 += deg(LeftShift(sig0,shift)+sig1*u*rho+sig2*u*u*omega)-ddeg-shift;
      div3 += deg(LeftShift(sig0,shift)+sig1*u*u*rho+sig2*u*omega)-ddeg-shift;
  ...
  cout<<"div(phi_"<<m<<") = ("<<div1<<", "<<div2<<", "<<div3<<")"<<endl<<endl;
...
void regulator(){
  cout<<"deg(e_1) = "<<deg(LeftShift(e0,shift)+e1*rho+e2*omega)-shift<<" deg(e'_1) = "<<deg(LeftShift(e0,shift)+e1*u*rho+e2*u*u*omega)-shift<<" deg(e\"_1) = "<< deg(LeftShift(e0,shift)+e1*u*u*rho+e2*u*omega)-shift<<endl;
cout<<"deg(e_2) = "<<deg(LeftShift(f0,shift)+f1*rho+f2*omega)-shift<<" deg(e'_2) = "<<deg(LeftShift(f0,shift)+f1*u*rho+f2*u*u*omega)-shift<<" deg(e\"_2) = "<< deg(LeftShift(f0,shift)+f1*u*u*rho+f2*u*omega)-shift<<endl;
