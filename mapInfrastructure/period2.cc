...
void hops(){
  ...
  for(int z = 0; z<l; z++){
    ...
    phi0 = C[3*z], phi1 = C[3*z+1], phi2 = C[3*z+2];
    sig0 = I[6*z], sig1 = I[6*z+1], sig2 = I[6*z+2];
    tau0=I[6*z+3], tau1 = I[6*z+4], tau2 = I[6*z+5];
    d = D[z];
    do{
      cout<<"PHI_{("<<z<<", "<<m<<")} = ("<<phi0<<", "<<phi1<<", "<<phi2<<")/"<<d<<endl;
      cout<<"sig: {" <<sig0<<", "<<sig1<<", "<<sig2<<"}/"<<d<<endl;
      cout<<"tau: {" <<tau0<<", "<<tau1<<", "<<tau2<<"}/"<<d<<endl;
      /*      
      // Print phi.
    ...
    cout<<"Beginning at position z = "<<z<<":"<<endl;
    cout<<"The shift is:         j = "<<j<<"."<<endl;
    cout<<"The period is:        m = "<<m<<"."<<endl;
  }
}
